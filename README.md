...
- PHP, интегрированный с веб-сервером. Лучше Apache, так как в случае с ним вам будет понятнее, как решать проблему с большими видео-файлами (решение проблему указано выше).
